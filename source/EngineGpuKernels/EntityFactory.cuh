...
__inline__ __device__ Genome* EntityFactory::createGenomeFromTO(TOs const& to, int genomeIndex)
{
    ...
    genome->neuronWeightMutationRate1 = {genomeTO.neuronWeightMutationRate1.probability, genomeTO.neuronWeightMutationRate1.sigma};
    genome->neuronWeightMutationRate2 = {genomeTO.neuronWeightMutationRate2.probability, genomeTO.neuronWeightMutationRate2.sigma};
    genome->neuronAfMutationRate = genomeTO.neuronAfMutationRate;
