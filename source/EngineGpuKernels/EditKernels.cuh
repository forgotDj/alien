...
__global__ void cudaAddGenome(SimulationData data, CollectionTO dataTO, Creature** newGenome);  // changeDataTO contains only 1 genome
__global__ void cudaSetGenome(SimulationData data, Creature** newGenome, bool* result);
