...
{
    auto partition = calcSystemThreadPartitionNew(data.structuralOperations.getNumOrigEntries());
...
{
    auto partition = calcSystemThreadPartitionNew(data.objects.cells.getNumEntries());
