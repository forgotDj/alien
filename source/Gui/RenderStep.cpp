...
//{
//    auto shader = std::make_shared<_Shader>(vertexShader, fragmentShader, std::filesystem::path(), sharedStep->getShader()->getVbo());
//    return LineRenderStep(new _LineRenderStep(shader, sharedStep->getTargetData(), sharedStep));
//}
//
//_LineRenderStep::_LineRenderStep(Shader const& shader, TargetData const& targetData, RenderStep const& dependentStep)
//    : _RenderStep(shader, targetData, {dependentStep})
//{
//    auto vao = _shader->getVao();
//    auto vbo = _shader->getVbo();
