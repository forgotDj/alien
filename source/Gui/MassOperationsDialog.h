...
private:
    ...
    bool _checkedCellColors[MAX_COLORS] = {false, false, false, false, false, false, false, false};

    bool _randomizeGenomeColors = false;
    bool _checkedGenomeColors[MAX_COLORS] = {false, false, false, false, false, false, false, false};
