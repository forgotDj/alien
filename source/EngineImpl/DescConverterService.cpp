...
GenomeDesc DescConverterService::createGenomeDesc(TOs const& to, int genomeIndex) const
{
    ...
    result._mutation._lineageMutationProbability = genomeTO.mutation.lineageMutationProbability;
    result._mutation._neuronMutation1._probability = genomeTO.mutation.neuronMutation1.probability;
    result._mutation._neuronMutation1._weightSigma = genomeTO.mutation.neuronMutation1.weightSigma;
    result._mutation._neuronMutation1._biasSigma = genomeTO.mutation.neuronMutation1.biasSigma;
    result._mutation._neuronMutation1._activationFunctionProbability = genomeTO.mutation.neuronMutation1.activationFunctionProbability;
    result._mutation._neuronMutation2._probability = genomeTO.mutation.neuronMutation2.probability;
    result._mutation._neuronMutation2._weightSigma = genomeTO.mutation.neuronMutation2.weightSigma;
    result._mutation._neuronMutation2._biasSigma = genomeTO.mutation.neuronMutation2.biasSigma;
    result._mutation._neuronMutation2._activationFunctionProbability = genomeTO.mutation.neuronMutation2.activationFunctionProbability;
    result._mutation._connectionMutationRate1._probability = genomeTO.mutation.connectionMutationRate1.probability;
    result._mutation._connectionMutationRate1._sigma = genomeTO.mutation.connectionMutationRate1.sigma;
    result._mutation._connectionMutationRate2._probability = genomeTO.mutation.connectionMutationRate2.probability;
    result._mutation._connectionMutationRate2._sigma = genomeTO.mutation.connectionMutationRate2.sigma;
    ...
    std::unordered_map<uint64_t, uint64_t>& genomeTOIndexById) const
{
    ...
    genomeTO.mutation.lineageMutationProbability = genome._mutation._lineageMutationProbability;
    genomeTO.mutation.neuronMutation1 = {
        genome._mutation._neuronMutation1._probability,
        genome._mutation._neuronMutation1._weightSigma,
        genome._mutation._neuronMutation1._biasSigma,
        genome._mutation._neuronMutation1._activationFunctionProbability};
    genomeTO.mutation.neuronMutation2 = {
        genome._mutation._neuronMutation2._probability,
        genome._mutation._neuronMutation2._weightSigma,
        genome._mutation._neuronMutation2._biasSigma,
        genome._mutation._neuronMutation2._activationFunctionProbability};
    genomeTO.mutation.connectionMutationRate1 = {genome._mutation._connectionMutationRate1._probability, genome._mutation._connectionMutationRate1._sigma};
    genomeTO.mutation.connectionMutationRate2 = {genome._mutation._connectionMutationRate2._probability, genome._mutation._connectionMutationRate2._sigma};
