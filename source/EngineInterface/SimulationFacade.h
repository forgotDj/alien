...
public:
    ...
    //
    virtual void tryCopyBuffersFromCudaToOpenGL(OpenGlGeometryBuffers const& geometryBuffers, RealRect const& visibleWorldRect) = 0;
    ...
    virtual CpuGeometryBuffers testOnly_getGeometryBuffers() = 0;
