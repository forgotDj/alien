...
namespace Const
{
    ...
    std::filesystem::path const BackgroundObjectFragmentShader = ShaderPath / "BackgroundObject.fs";
    std::filesystem::path const ForegroundObjectFragmentShader = ShaderPath / "ForegroundObject.fs";
